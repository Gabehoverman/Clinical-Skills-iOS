//
//  SpecialTestOverviewTableViewController.swift
//  Clinical Skills
//
...
class SpecialTestOverviewTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 4: cell.textLabel?.text = self.component?.inspection
        case 1:
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if indexPath.section == 0 {
            let fixedSectionIndexPath = IndexPath(row: indexPath.row, section: 0)
            if let managedSpecialTest = self.specialTestsFetchedResultsController?.object(at: fixedSectionIndexPath) as? SpecialTestManagedObject {
                self.performSegue(withIdentifier: "toSpecialTestsDetailView", sender: managedSpecialTest)
            }
        }
    }
...
extension SpecialTestOverviewTableViewController : RemoteConnectionManagerDelegate {
...
extension SpecialTestOverviewTableViewController : DatastoreManagerDelegate {
